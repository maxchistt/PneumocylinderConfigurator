...
Приложение позволяет построить параметрическую модель по длине хода и диаметру поршня, варианту цветовой схемы, а так же настроить стиль отображения в сцене, сечение модели и прозрачность корпуса
